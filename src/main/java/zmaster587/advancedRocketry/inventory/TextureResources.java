...
public class TextureResources {
    ...
    public static final ResourceLocation[] buttonGreen = {new ResourceLocation("advancedrocketry", "textures/gui/buttons/greenbutton.png"), new ResourceLocation("advancedrocketry", "textures/gui/buttons/greenbutton.png"), null, null};
